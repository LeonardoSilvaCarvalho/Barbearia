            ...
            <div class="appointments_days">
                <?php
                    ...
                    for($i = 0; $i < 10; $i++)
                    {
                        ...
                        $dayNamePt = $daysOfWeekPt[$dayOfWeek];
                ...
                <?php
                    ...
                    for($i = 0; $i < 10; $i++)
                    {
                        echo "<div class='available_booking_hours_colum'>";
                            ...
                            {
                                // Verificar se o funcionário está disponível
                                ...
                                // Se o funcionário estiver disponível

                                if($stmt_emp->rowCount() != 0)
                                {

                                    // Verificar se não há agendamentos conflitantes com o atual
                                    $stmt = $con->prepare("
                                        Select * 
                                        from appointments a
                                        where
