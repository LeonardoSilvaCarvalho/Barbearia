...
?>
    ...
    <div class="container-fluid">
        ...
        ?>
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold text-primary">Serviços</h4>
                </div>
                <div class="card-body">

                    <!-- ADICIONAR NOVO BOTÃO DE SERVIÇO -->
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($rows_services as $service) {
                                ...
                                echo "</td>";
                                echo "<td>";
                                echo "R$" . $service['service_price'];
                                echo "</td>";
                                echo "<td>";
                                echo $service['service_duration'] . 'min';
                                echo "</td>";
                                echo "<td>";
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Certeza que deseja excluir o serviço: "<?php echo $service['service_name']; ?>" ?
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                                        <button type="button" data-id="<?php echo $service['service_id']; ?>" class="btn btn-danger delete_service_bttn">Excluir</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        ?>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold text-primary">Cadastrar novo serviço</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['service_name'])) ? htmlspecialchars($_POST['service_name']) : '' ?>" placeholder="Nome do seviço" name="service_name">
                                    <?php
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['service_duration'])) ? htmlspecialchars($_POST['service_duration']) : '' ?>" placeholder="Duração do serviço" name="service_duration">
                                    <?php
                                    ...
                                    ?>
                                            <div class="invalid-feedback" style="display: block;">
                                                Duração do serviço e obrigatorio
                                            </div>
                                        <?php
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="service_price">Preço do Serviço(R$)</label>
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['service_price'])) ? htmlspecialchars($_POST['service_price']) : '' ?>" placeholder="Preço do serviço" name="service_price">
                                    <?php
                                    ...
                                    ?>
                                            <div class="invalid-feedback" style="display: block;">
                                                Preço do serviço e obrigatorio
                                            </div>
                                        <?php
                                        ...
                                        ?>
                                            <div class="invalid-feedback" style="display: block;">
                                                Preço invalido (coloque apenas o valor cheio)
                                            </div>
                                    <?php
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    ?>
                                            <div class="invalid-feedback" style="display: block;">
                                                Descrição do serviço e obrigatorio
                                            </div>
                                        <?php
                                        ...
                                        ?>
                                            <div class="invalid-feedback" style="display: block;">
                                                O comprimento da descrição deve ser inferior a 250 letras.
                                            </div>
                                    <?php
                    ...
                    ?>
                            ...
                            <script type="text/javascript">
                                swal("Novo Serviço", "O novo serviço foi criado com sucesso.", "success").then((value) => {
            ...
            ?>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h4 class="m-0 font-weight-bold text-primary">Editar Serviço</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="services.php?do=Edit&service_id=<?php echo $service_id; ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="service_name">Nome do serviço</label>
                                            <input type="text" class="form-control" value="<?php echo $service['service_name'] ?>" placeholder="Nome do serviço" name="service_name">
                                            <?php
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="service_duration">Duração do serviço(min)</label>
                                            <input type="text" class="form-control" value="<?php echo $service['service_duration'] ?>" placeholder="Duração do serviço" name="service_duration">
                                            <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="service_price">Preço do Serviço(R$)</label>
                                            <input type="text" class="form-control" value="<?php echo $service['service_price'] ?>" placeholder="Preço do Serviço" name="service_price">
                                            <?php
                                ...
                                <!-- BOTÃO ENVIAR -->
                                <button type="submit" name="edit_service_sbmt" class="btn btn-primary">Editar Serviço</button>
                            </form>
                            ...
                            ?>
                                    ...
                                    <script type="text/javascript">
                                        swal("Serviço Atualizado", "Este serviço foi atualizado corretamente", "success").then((value) => {
                                            window.location.replace("services.php");
                                        });
                                    </script>
